...
public class FlowLayout extends ViewGroup {
    ...
    private void init() { // Specify the margins for the children
        marginHorizontal = getResources().getDimensionPixelSize(R.dimen.activity_horizontal_margin);
        marginVertical = getResources().getDimensionPixelSize(R.dimen.activity_vertical_margin);
    }
